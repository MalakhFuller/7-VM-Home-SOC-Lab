...
I could have stopped at the DC's Security log. The event was right there at the source; case closed. I didn't — and the reason is the same corroboration instinct that ran through this entire build: a single source is a lead, not a finding. You confirm it a second and third way, independent of the first, before you'll put your name on it and let someone act on it.
